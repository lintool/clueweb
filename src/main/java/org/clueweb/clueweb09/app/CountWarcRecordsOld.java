...
import org.clueweb.clueweb09.mapred.ClueWeb09InputFormat;
...
public class CountWarcRecordsOld extends Configured implements Tool {
  ...
  private static class MyMapper extends MapReduceBase implements
      Mapper<Writable, ClueWeb09WarcRecord, NullWritable, NullWritable> {

    public void configure(JobConf job) {}

    public void map(Writable key, ClueWeb09WarcRecord doc,
