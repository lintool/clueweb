...
public class QuickSort {
  ...
  public static void quicksortWithSecondary(int[] keys, int[] counts, short[] counts2, int left,
      int right) {
    if (right <= left)
      return;
  ...
  public static void quicksortWithSecondary(int[] keys, int[] counts, long[] counts2, int left,
      int right) {
    if (right <= left)
      return;
    int i = partitionWithSecondary(keys, counts, counts2, left, right);
  ...
  private static int partitionWithSecondary(int[] keys, int[] counts, short[] counts2, int left,
      int right) {
    int i = left - 1;
    int j = right;
    while (true) {
      do {
        i++;
      } while (counts[i] < counts[right] || (counts[i] == counts[right] && keys[i] < keys[right])) // find
      // item
      // on
      // left
      // to
  ...
  private static int partitionWithSecondary(int[] keys, int[] counts, long[] counts2, int left,
      int right) {
    int i = left - 1;
    int j = right;
    while (true) {
