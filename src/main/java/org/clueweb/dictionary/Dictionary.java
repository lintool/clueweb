...
/**
 * A dictionary provides a bidirectional mapping terms (Strings) and term ids
 * (integers). The semantics of the mapping is left unspecified, but the
 * iteration order is always in increasing term id.
 * 
 * @author Jimmy Lin
 */
